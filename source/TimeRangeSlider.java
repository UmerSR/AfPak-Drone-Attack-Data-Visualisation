...
public class TimeRangeSlider {
  ...
  // Whether slider is curr ently animated
  ...
  protected float labelPadding = 10;
  ...
  private boolean draggedSelectedTimeRange = true;
  private boolean draggedStartHandle = true;
  private boolean draggedEndHandle = true;
  protected float startHandleX;
  protected float endHandleX;
  protected float handleWidth;
  private float handleHeight;

  protected boolean inProximity = true;
  ...
  public TimeRangeSlider(PApplet p, float x, float y, float width, float height, DateTime startDateTime, 
    ...
    aggregationIntervalSeconds = aggregationIntervalSeconds * 12;
  ...
  protected void drawStartEndTimeLabels() {
    ...
    String startTimeLabel = startDateTime.toString("MM/yyyy");
    ...
    String endTimeLabel = endDateTime.toString("MM/yyyy");
  ...
  protected void drawTimeRangeLabels() {
    TimeRangeLabel = currentStartDateTime.toString("MM/yyyy") + " - " + currentEndDateTime.toString("MM/yyyy");
